    ...
    <div className="min-h-screen bg-slate-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {authLoading || (isLoading && !profile) ? (
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="flex items-center justify-center min-h-[calc(100vh-160px)] py-20">
              <div className="text-center">
                ...
                <p className="mt-4 text-slate-600">Loading your school assessment data...</p>
              </div>
            </div>
          </div>
        ) : !user ? (
          <div className="py-12">
            <div className="bg-primary-soft border border-primary/25 rounded-lg p-6 text-center">
              <h2 className="text-xl font-semibold text-ink mb-2">School results need an account</h2>
              <p className="text-primary-hover mb-4 text-sm">
              ...
              <a href="/login" className="inline-block px-5 py-2 bg-primary text-white rounded-md hover:bg-primary-hover text-sm font-medium">
                Log in / Sign up
              </a>
            </div>
          </div>
          ...
          <div className="py-20">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">No Assessment Data Found</h2>
              <p className="text-slate-600 mb-6">
                Complete the school assessment to see personalized EdTech recommendations. The events finder below works regardless.
              </p>
              <button className="px-6 py-3 bg-primary text-white rounded-md hover:bg-primary-hover">
                Go to Assessment
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="px-6 py-4 border-b bg-surface-muted">
            ...
            <div className="p-6">
              {compatibilityResults.length > 0 ? (
                <>
                  <div className="mb-6">
                    <h2 className="text-xl font-semibold text-slate-800 mb-4">Tool Compatibility Scores</h2>
                        ...
                        return (
                          <div key={result.toolId} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                            ...
                            <div className="pt-3 border-t border-slate-100">
                              <h4 className="font-medium text-slate-800 mb-2">💡 Recommendation:</h4>
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-200">
                    <h2 className="text-xl font-semibold text-slate-800 mb-4">Summary & Next Steps</h2>
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-primary-soft rounded-[10px]">
                        <h3 className="font-medium text-ink mb-2">AI-Powered Insights</h3>
                ...
                <p className="text-slate-500 text-center py-12">No EdTech tools available for comparison.</p>
              )}
            </div>
          </div>
        )}
